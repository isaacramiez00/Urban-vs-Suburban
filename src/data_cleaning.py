...
# clean
def address_sample_df(df, addressColumn, city, state='co', filterDict={}, replaceColumnName='address', sample=1, seed=463):
    '''  
...
def get_zillow_data():
    ...
    urban_denver_df = address_sample_df(urban_denver_df, 'FULL_ADDRESS', 'denver', sample=5)
    ...
    urb_df.to_csv('/Users/isaacramirez/code/dsi/capstone-I/data/zillowQueryUrban.csv')
    sub_df.to_csv('/Users/isaacramirez/code/dsi/capstone-I/data/zillowQuerySuburb.csv')
...
def shape_zillow_size(urb_df, sub_df):
    ...
    '''
    suburbs_df = deep_search_sample(sub_df)
    urban_denver_df = deep_search_sample(urb_df)
